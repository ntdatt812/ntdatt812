...
[![Landed](https://img.shields.io/badge/landed-81_PRs_%2B_6_commits-d97757?style=flat-square&labelColor=161b22)](https://github.com/ntdatt812)
...
[![Open](https://img.shields.io/badge/open_for_review-77_PRs-8b949e?style=flat-square&labelColor=161b22)](https://github.com/ntdatt812)
...
Public data for [`ntdatt812`](https://github.com/ntdatt812), counted **2026-09-06**,
...
| --- | ---: | --- |
| Pull requests merged | **81** | Merged by maintainers of repos I don't own |
...
| Pull requests open | **77** | Awaiting maintainer review |
| Repositories | **18** | Third-party repos I've contributed to |
...
| [decolua/9router](https://github.com/decolua/9router) | 27.2k★ | 23 open, including [#3369](https://github.com/decolua/9router/pull/3369) recovering a tool result that arrived without an id, and [#3368](https://github.com/decolua/9router/pull/3368) stopping a hard-coded heap cap from overriding the operator. |
| [h4ckf0r0day/obscura](https://github.com/h4ckf0r0day/obscura) | 26.1k★ | 3 open, all against the engine rather than around it. [#778](https://github.com/h4ckf0r0day/obscura/pull/778) honours `acceptLanguage` on both spellings of `setUserAgentOverride` — the `Emulation` one was acknowledged without being applied, so a client that set a user agent or a locale there was told it worked and got neither. [#780](https://github.com/h4ckf0r0day/obscura/pull/780) reports a primitive's own value through CDP instead of its description string. [#782](https://github.com/h4ckf0r0day/obscura/pull/782) pins the shape of a `blob:` URL. The fix landed from another contributor while this was open, and the test that came with it asserts only the `blob:` scheme — which the `blob:obscura/<base36>` form the issue was filed about also satisfies — so what is left here is the two tests that fix went in without. |
