...
[![Landed](https://img.shields.io/badge/landed-57_PRs_%2B_6_commits-d97757?style=flat-square&labelColor=161b22)](https://github.com/ntdatt812)
...
[![Open](https://img.shields.io/badge/open_for_review-85_PRs-8b949e?style=flat-square&labelColor=161b22)](https://github.com/ntdatt812)
...
| --- | ---: | --- |
| Pull requests merged | **57** | Merged by maintainers of repos I don't own |
...
| Pull requests open | **85** | Awaiting maintainer review |
...
| [nicolargo/glances](https://github.com/nicolargo/glances) | 33.5k★ | 5 open, all the same shape in the WebUI: a cell coloured from a different value than the one it prints. [#3695](https://github.com/nicolargo/glances/pull/3695) reads the ports status the way the API sends it and uses the web alert; [#3696](https://github.com/nicolargo/glances/pull/3696) matches the AMP alert to the plugin's `get_alert`; [#3697](https://github.com/nicolargo/glances/pull/3697) matches the VM status colour to `vm_alert`; [#3698](https://github.com/nicolargo/glances/pull/3698) colours the per-CPU `iowait` cell by `iowait` rather than `system`; and [#3699](https://github.com/nicolargo/glances/pull/3699) colours the process `MEM%` cell by `memory_percent` rather than `cpu_percent`. |
