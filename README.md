...
[![Landed](https://img.shields.io/badge/landed-108_PRs_%2B_6_commits-d97757?style=flat-square&labelColor=161b22)](https://github.com/ntdatt812)
...
Public data for [`ntdatt812`](https://github.com/ntdatt812), counted **2026-09-11**,
...
| --- | ---: | --- |
| Pull requests merged | **108** | Merged by maintainers of repos I don't own |
...
| --- | --- | --- |
| [github/spec-kit](https://github.com/github/spec-kit) | 135k★ | 4 open. [#4295](https://github.com/github/spec-kit/pull/4295) — a `switch` expression that is never evaluated: the hole #4292 closed, one construct over. Also [#4313](https://github.com/github/spec-kit/pull/4313), which counts checkbox markers outside code fences only; [#4314](https://github.com/github/spec-kit/pull/4314), which scopes issue dedup to the feature the tasks belong to; and [#4330](https://github.com/github/spec-kit/pull/4330), which stops `converge` re-appending work an unchecked task already tracks. |
