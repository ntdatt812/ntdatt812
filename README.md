...
[![Landed](https://img.shields.io/badge/landed-111_PRs_%2B_6_commits-d97757?style=flat-square&labelColor=161b22)](https://github.com/ntdatt812)
...
[![Open](https://img.shields.io/badge/open_for_review-66_PRs-8b949e?style=flat-square&labelColor=161b22)](https://github.com/ntdatt812)
...
| --- | ---: | --- |
| Pull requests merged | **111** | Merged by maintainers of repos I don't own |
...
| Pull requests open | **66** | Awaiting maintainer review |
...
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | 93.7k★ | 4 open. [#3619](https://github.com/thedotmack/claude-mem/pull/3619) — the provider recorded every assistant reply into the conversation history twice, and nothing dedupes it before it becomes the request's `messages` array, so the assistant half of every later request was double-billed. [#3727](https://github.com/thedotmack/claude-mem/pull/3727) stops the worker daemon holding the user's project directory as its cwd, which on Windows locks the folder against rename and move for as long as the daemon lives. Also [#3620](https://github.com/thedotmack/claude-mem/pull/3620), which names the `max_tokens` cap when it truncates an observation, and [#3593](https://github.com/thedotmack/claude-mem/pull/3593), which pins observation type handling against the mode enum. |
