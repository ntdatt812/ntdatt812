...
[![Landed](https://img.shields.io/badge/landed-32_PRs_%2B_6_commits-d97757?style=flat-square&labelColor=161b22)](https://github.com/ntdatt812)
...
| --- | ---: | --- |
| Pull requests merged | **32** | Merged by maintainers of repos I don't own |
...
| [nicolargo/glances](https://github.com/nicolargo/glances) | 33.4k★ | 8 open. [#3677](https://github.com/nicolargo/glances/pull/3677) — the ICMP timeout was sent in the wrong unit, so healthy remote hosts read as offline. Then a pass over the alert and WebUI paths: [#3684](https://github.com/nicolargo/glances/pull/3684) alerts on the disk bitrate rather than a field the WebUI never reads, [#3683](https://github.com/nicolargo/glances/pull/3683) alerts on the tracked connection percentage instead of on 0, and [#3682](https://github.com/nicolargo/glances/pull/3682) colours the per-CPU iowait cell from iowait. |
