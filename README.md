...
[![Landed](https://img.shields.io/badge/landed-112_PRs_%2B_6_commits-d97757?style=flat-square&labelColor=161b22)](https://github.com/ntdatt812)
...
[![Open](https://img.shields.io/badge/open_for_review-65_PRs-8b949e?style=flat-square&labelColor=161b22)](https://github.com/ntdatt812)
...
| --- | ---: | --- |
| Pull requests merged | **112** | Merged by maintainers of repos I don't own |
...
| Pull requests open | **65** | Awaiting maintainer review |
...
Six more were rebased onto `main` and squash-merged by the maintainer as pull requests of their own (#3995, #3996, #3998, #3999, #4000 and #4001), five of them keeping my co-author credit. They are not counted above.
...
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | 93.7k★ | 3 open. [#3619](https://github.com/thedotmack/claude-mem/pull/3619) — the provider recorded every assistant reply into the conversation history twice, and nothing dedupes it before it becomes the request's `messages` array, so the assistant half of every later request was double-billed. Also [#3620](https://github.com/thedotmack/claude-mem/pull/3620), which names the `max_tokens` cap when it truncates an observation, and [#3593](https://github.com/thedotmack/claude-mem/pull/3593), which pins observation type handling against the mode enum. |
